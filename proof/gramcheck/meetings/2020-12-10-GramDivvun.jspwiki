...
real-PlNomPxSg2-PlNom       |  23 | 110 |   67 |  550 | -- e ute  | x    | D skal gjera
real-NSgIll-ASgNom          |  16 |  50 |   11 |  150 |           |      |
real-Ess-PrfPrc             |   1 | 100 |  470 |   11 | -- e ute  | x    | L jobbe med det
real-DerNomActSgGen-PrfPrc  |  50 | 200 |  150 |  800 | skal ut   | x    | D
real-DerNomActSgGen-PrsSg1  |  37 |  30 |   28 | 1450 | skal ut   | x    | D
real-DerNomActSgGen-PrtSg1  |     |     |      |      |           | x    | D
...
```
    ...
    1. `real-NomAgIll-PrtSg3.notfixed.yaml`
```
...
```
    ...
    1. `real-PlNomPxSg2-PlNom.notfixed`

`No such file or directory`

    1. `real-Ess-PrfPrc` + Actio Gen/Actio Nom
```
...
```
    ...
    1. `real-Ess-PrfPrc.notfixed` + Actio Gen/Actio Nom

NoneType' object is not iterable

    1. `real-DerNomActSgGen-PrfPrc`
```
...
```
    ...
    1. `real-DerNomActSgGen-PrfPrc-notfixed`
```
