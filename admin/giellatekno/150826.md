...
1. PhD-stilling Giellatekno
1. Programmerarstilling MT
1. Detmar 14.-25.9.
1. nob-sme  ordbok
1. sme-sma MT artikkel
1. Cifu-referat
1. Forskingsprosjekt: Giellatekno og Divvun sine språkverkty

##  3-årig programmerarstilling
3-årig programmerarstilling Giellatekno: 31 søkarar, kven skal vere i komité?

* 1 fra IT-adv, Ciprian, Trond, (evt. Lene hvis ingen dame fra IT-adv.)

##  PhD-stilling Giellatekno
PhD-stilling Giellatekno: Ingen søkarar, ny søknadsfrist om 3 veker (no 2). Idéar?
* spre informasjon på epostlister (SESAM),
* info på egen webside
* Facebook divvun, twitter...
...
Presentasjon av undersøking om Giellatekno, jf. [abstract|
http://www.oulu.fi/sites/default/files/content/CIFU12BookOfAbstracts_0.pdf] ,
søk på stikkordet (tittelen):
